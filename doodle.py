...
class Paint:
    ...
    def __init__(self):
        ...
        self.zoom_in_img = ImageTk.PhotoImage(Image.open("Pictures/zoom in.png").resize((25, 20), Image.ANTIALIAS))
        ...
        self.zoom_out_img = ImageTk.PhotoImage(Image.open("Pictures/zoom out.png").resize((25, 20), Image.ANTIALIAS))
        ...
        for color in colors:
            ...
            if i == 6:
                ...
                j = 1
        # CREATING BUTTONS:
        self.eraser_img = ImageTk.PhotoImage(Image.open("Pictures/eraser.png").resize((28, 20), Image.ANTIALIAS))
        ...
        self.pencil_img = ImageTk.PhotoImage(Image.open("Pictures/pencil.png.").resize((24, 20), Image.ANTIALIAS))
        ...
        self.line_img = ImageTk.PhotoImage(Image.open("Pictures/line.png").resize((24, 20), Image.ANTIALIAS))
        ...
        self.colorbox_img = ImageTk.PhotoImage(Image.open("Pictures/bucket.png").resize((25, 20), Image.ANTIALIAS))
        ...
        self.circle_img = ImageTk.PhotoImage(Image.open("Pictures/circle.png").resize((24, 20), Image.ANTIALIAS))
        ...
        self.parallelogram_img = ImageTk.PhotoImage(Image.open("Pictures/parallelogram.png").resize((24, 20), Image.ANTIALIAS))
        ...
        self.selection_img = ImageTk.PhotoImage(Image.open("Pictures/selection_box.png").resize((24, 20), Image.ANTIALIAS))
        ...
        self.screen_shot_img = ImageTk.PhotoImage(Image.open("Pictures/screen_shot.png").resize((24, 20), Image.ANTIALIAS))
    ...
    def about(self):
        ...
        self.about_img[0] = ImageTk.PhotoImage(
            Image.open("Pictures/colours.png").resize((140, 160), Image.ANTIALIAS))
        self.about_img[1] = ImageTk.PhotoImage(
            Image.open("Pictures/width_box.png").resize((140, 160), Image.ANTIALIAS))
        self.about_img[2] = ImageTk.PhotoImage(
            Image.open("Pictures/tools.png").resize((140, 160), Image.ANTIALIAS))
        self.about_img[3] = ImageTk.PhotoImage(
            Image.open("Pictures/menu_bar.jpeg").resize((160, 160), Image.ANTIALIAS))
